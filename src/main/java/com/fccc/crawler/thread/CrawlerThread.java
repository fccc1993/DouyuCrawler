...
import com.fccc.crawler.handler.MessageHandler;
import com.fccc.crawler.handler.ResponseParser;
import com.fccc.crawler.util.*;
...
public class CrawlerThread implements Runnable {
    ...
    List<ServerInfo> danmakuServers = new ArrayList<ServerInfo>();
